...
class MatriculaService:
    ...
    def create(self, matricula_data: schemas.MatriculaCreate):
        ...
        codigo = (
            matricula_data.placa[0]
            + matricula_data.placa[1]
            + matricula_data.placa[2]
            + str(len(matricula_data.propietario))
            + str(matricula_data.fabricacion)[-1]   # 🔥 aquí está la corrección
        )
